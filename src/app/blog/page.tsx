...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content:
      'Узнайте, как оптимизировать библиотеки компонентов для максимальной производительности. Мы рассмотрим методы ленивой загрузки, tree shaking, code splitting и другие техники, которые помогут создать быстрые и эффективные React приложения.',
    tags: [
      'Производительность',
      'Оптимизация',
      'React',
  ...
  },
  {
    ...
    content:
      'Изучите современные паттерны и лучшие практики в React разработке. От custom hooks до compound components, от render props до higher-order components - мы рассмотрим все актуальные подходы для создания масштабируемых React приложений.',
  ...
  },
  {
    ...
    content:
      'Погрузитесь в мир TypeScript и узнайте, как он может улучшить вашу веб-разработку. Мы рассмотрим продвинутые типы, утилиты, generics и покажем, как создавать типобезопасные приложения с отличным developer experience.',
    tags: [
      'TypeScript',
      'Типизация',
      'Веб-разработка',
