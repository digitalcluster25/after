          ...
          <article className='prose prose-lg max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-p:leading-relaxed prose-p:text-muted-foreground prose-li:text-muted-foreground'>
            <div id='introduction' className='mb-8'>
              <p className='text-xl leading-relaxed mb-6 text-foreground font-medium'>
                ...
                ккал/день. Правильное измерение этого параметра критически важно
                для оценки энергетического баланса и планирования тренировок.
              </p>
            </div>
            ...
            <p className='text-lg leading-relaxed mb-6'>
              ...
              применяются косвенные методы: расчет по формуле Харриса-Бенедикта
              с учетом коэффициента активности, использование фитнес-трекеров с
              акселерометрами, или ведение дневника активности с последующим
            ...
            <p className='text-lg leading-relaxed mb-6'>
              ...
              коэффициент активности (1.2-2.5 в зависимости от уровня физической
              активности). Формула учитывает пол, возраст, вес и рост человека.
            </p>
            ...
            <p className='text-lg leading-relaxed mb-6'>
              ...
              автоматически отслеживают активность и рассчитывают энергозатраты.
              Точность зависит от качества датчиков и алгоритмов обработки
              данных.
            </p>
            ...
            <p className='text-lg leading-relaxed mb-6'>
              Энергия, необходимая для поддержания основных жизненных функций в
              состоянии покоя. Составляет 60-75% от общего суточного расхода
              энергии.
            </p>
            ...
            <p className='text-lg leading-relaxed mb-6'>
              ...
              тренированности. Нормальные значения активности варьируются от 100
              до 1000 ккал/день в зависимости от образа жизни и целей.
            ...
            <p className='text-lg leading-relaxed mb-6'>
              Для получения точных данных рекомендуется комбинировать несколько
              методов измерения. Используйте фитнес-трекер для ежедневного
              мониторинга, периодически проверяйте точность с помощью дневника
              активности, а при необходимости обращайтесь к специалистам для
              проведения калориметрии.
            </p>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-blue-800 text-lg leading-relaxed'>
                    ...
                    виды физической нагрузки. Это поможет вам лучше понять свои
                    энергозатраты и скорректировать тренировочную программу.
                  </p>
                </div>
              </div>
            </div>
