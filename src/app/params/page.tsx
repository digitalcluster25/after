...
const activityParams: ListItem[] = [
  ...
  },
  {
    ...
    physicalEffects:
      'Развивает выносливость и силу верхней части тела.',
    psychologicalEffects: 'Повышает уверенность при нахождении в открытой воде.',
    measurement:
  ...
  },
  {
    ...
    physicalEffects:
      'Повышает аэробную выносливость, укрепляет мышцы ног.',
    psychologicalEffects: 'Дает ощущение скорости и свободы, помогает исследовать новые места.',
    measurement:
  ...
  },
  {
    ...
    physicalEffects:
      'Улучшает чувство равновесия и координацию, укрепляет мышцы ног.',
    psychologicalEffects: 'Динамичная активность, которая поднимает настроение.',
    measurement:
  ...
  },
  {
    ...
    physicalEffects: 'Показывает эффективность техники, влияет на расход энергии.',
    psychologicalEffects: 'Способствует концентрации и медитативному состоянию.',
  ...
  },
  {
    ...
    physicalEffects: 'Учитывает любую активность, способствует повышению тонуса.',
  ...
  },
  {
    ...
    category: 'Кардио',
    description: 'Основной показатель интенсивности тренировки и состояния сердечно-сосудистой системы.',
    unit: 'уд/мин',
    ranges: {
      min: '< 60',
      low: '60 - 100',
    ...
    physicalEffects: 'Основной показатель интенсивности тренировки и состояния сердечно-сосудистой системы.',
    psychologicalEffects: 'Помогает контролировать нагрузку и избегать перетренированности.',
  ...
  },
  {
    ...
    description: 'Показывает количество энергии, потраченной во время активности.',
    unit: 'ккал',
    ranges: {
      min: '< 100',
      low: '100 - 300',
    ...
    physicalEffects: 'Показывает количество энергии, потраченной во время активности.',
    psychologicalEffects: 'Мотивирует к продолжению тренировок, дает чувство достижения.',
    measurement: 'Фитнес-трекер или смарт-часы с учетом веса, возраста, пола и интенсивности.',
    auto: true,
    manual: false,
  },
  {
    ...
    category: 'Общая активность',
    description: 'Продолжительность физической активности влияет на адаптацию организма.',
    unit: 'мин',
    ranges: {
      min: '< 15',
      low: '15 - 30',
    ...
    physicalEffects: 'Продолжительность физической активности влияет на адаптацию организма.',
    psychologicalEffects: 'Развивает дисциплину и привычку к регулярным тренировкам.',
  ...
  },
  {
    ...
    psychologicalEffects: 'Создает мотивацию к движению, дает чувство ежедневного достижения.',
  ...
  },
  {
    ...
    psychologicalEffects: 'Дает общее представление об уровне активности, мотивирует к улучшению.',
    measurement: 'Алгоритм фитнес-трекера, учитывающий различные виды активности.',
    auto: true,
    manual: false,
  },
  {
