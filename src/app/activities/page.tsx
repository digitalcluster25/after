...
const activities: ActivityItem[] = [
  ...
  },
  {
    ...
    description:
      'Скоростной спуск с гор на лыжах, требующий хорошей физической подготовки.',
  ...
  },
  {
    ...
    description:
      'Зимний вид спорта, развивающий баланс и координацию движений.',
  ...
  // Общая активность
  {
    ...
    description:
      'Ежедневные движения и активности, поддерживающие общий тонус организма.',
  ...
  },
  {
    ...
    category: 'Повседневная активность',
    description:
      'Простая и доступная активность для укрепления ног и сердечно-сосудистой системы.',
  ...
  // Интенсивность
  {
    ...
    description:
      'Тренировки с отягощениями для развития силы и мышечной массы.',
  ...
  },
  {
    ...
    category: 'Интенсивность',
    description:
      'Тренировки, имитирующие повседневные движения с повышенной интенсивностью.',
    benefits: [
  ...
  // Адаптивный спорт
  {
    ...
    description:
      'Специально адаптированные физические упражнения для людей с ограниченными возможностями.',
    benefits: [
