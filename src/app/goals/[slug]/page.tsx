...
import { Target, Heart, Brain, Zap, Clock, Users, Activity, Mountain, ArrowLeft, CheckCircle, Calendar, TrendingUp } from 'lucide-react';
    ...
    methods: [
      {
        ...
        description: 'Создание умеренного дефицита калорий для безопасного снижения веса',
        steps: [
      ...
      },
      {
        ...
        description: 'Комбинация кардио и силовых тренировок для максимального эффекта',
        steps: [
    ...
    methods: [
      {
        ...
        description: 'Постепенное увеличение нагрузки для стимуляции роста мышц',
        steps: [
        ...
        <section className="pt-8 pb-8 md:pb-16">
          <div className="container px-0">
            <div className="text-center">
              <p className="text-gray-600 mb-4">Запрашиваемая цель не найдена.</p>
              <Link 
                href="/goals"
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-gray-600 text-base leading-relaxed mb-4">{goal.description}</p>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900">Способы достижения цели</h3>
                  ...
                  <Card key={index} className="border border-gray-200">
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-2">
                        <h5 className="text-sm font-medium text-gray-700">Пошаговый план:</h5>
            ...
            {/* Временная шкала */}
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900">План по неделям</h3>
                    ...
                    <CardContent className="p-6">
                      ...
                      <ul className="space-y-2">
                        {period.activities.map((activity, activityIndex) => (
                          <li key={activityIndex} className="text-sm text-gray-600 flex items-start gap-2">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="border border-gray-200">
                <CardContent className="p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Важные советы</h4>
                  <ul className="space-y-2">
              ...
              <Card className="border border-gray-200">
                <CardContent className="p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Что измерять</h4>
                  <ul className="space-y-2">
